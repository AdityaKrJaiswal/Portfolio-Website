...
const Contact = () => {
  ...
  return (
    <div
      name="Contact"
      className="container max-w-screen-xl mx-auto px-4 md:px-20 mt-20 pt-20 md:mt-10"
    >
      <h1 className="w-full text-2xl mb-5 font-bold text-center">Contact</h1>
      <div className="flex flex-col justify-center items-center">
        <form
          onSubmit={handleSubmit(onSubmit)}
          className="bg-slate-500 w-full max-w-md md:max-w-lg px-8 py-6 rounded-xl"
        >
          ...
          <div className="flex flex-col mt-4">
            ...
            <textarea
              ...
              id="message"
              name="message"
              className="w-full mt-2 p-2 rounded-lg min-h-[80px] h-auto"
